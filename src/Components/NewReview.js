...
class NewReview extends Component {
  ...
  postReview = event => {
    ...
    if (this.state.barVal === 0 || this.state.starVal === 0) {
      alert("Please complete review");
    } else {
      ...
      <form className="new-tweet">
        <fieldset className="new-tweet-field">
          ...
          <select onChange={this.barListener}>
            <option selected disabled>Your GitLit History</option>
